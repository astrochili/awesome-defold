          ...
          messages: [
            ...
            },
            {
              ...
              content: [
                ...
                "Title style: use the official project/game/library name, preserve normal capitalization, do not add platform labels or marketing subtitles unless they are part of the official name. Add '(NSFW)' only when the page is explicitly adult/NSFW.",
