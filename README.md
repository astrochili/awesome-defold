...
- [“Pasting” sprites into background](https://forum.defold.com/t/pasting-sprites-into-background-eg-blood/81830) — How to accumulate blood/paint on a canvas render target with fixed VRAM.
- [Beginners road-map](https://github.com/Ali-Al-Khuwaja/Defold-beginner-roadmap) — A roadmap for learning Defold, tailored for beginners.
...
- [Defold Editor Development. Tips and Tricks](https://forum.defold.com/t/defold-editor-development-tips-and-tricks/80710) — The tips which help work on Defold Editor tasks with joy.
- [Defold. Where to begin?](https://agulev.com/en/defold-s-chego-nachat-lua) — Starting point and tutorial for beginners in Defold.
- [DefragCoord](https://github.com/paweljarosz/defragcoord) — FragCoord to Defold migration guide.
...
- [How to Make Simple Lighting in Defold](https://goeshard.org/2025/08/07/how-to-make-simple-lighting-in-defold/) — Adding simple light maps to a 2D game.
...
- [One font merging](https://forum.defold.com/t/one-font-merging/81861) — Building a single, localization-ready font from multiple families and whitelisting only used characters.
- [Optimization of Sounds in Web Games](https://forum.defold.com/t/optimization-of-sounds-in-web-games/81860) — A practical guide to organizing and leveling game audio so it feels comfortable and takes less space.
...
- [Asatte Games](https://www.youtube.com/watch?v=D8nuGF-ymJQ&list=PLkdj9mBu4LRYRk9ArooFZXqxeRrrV_xV2) — A lot of short Defold tutorials.
...
- [Insality Games](https://www.youtube.com/@insalitygames/videos) — Druid, Panthera workshops and more.
...
- [Zenva](https://www.youtube.com/watch?v=affVW3XDsMk) — Defold Game Development Academy (paid with free intro).
- [Сделай игру с папой](https://www.youtube.com/@%D1%81%D0%B4%D0%B5%D0%BB%D0%B0%D0%B9%D0%B8%D0%B3%D1%80%D1%83%D1%81%D0%BF%D0%B0%D0%BF%D0%BE%D0%B9/videos) — How to build Defold games from scratch for beginners (Russian-language).
...
- [Agent Config](https://github.com/indiesoftby/defold-agent-config) — Example `AGENTS.md` setup and skills for AI-assisted Defold development.
...
- [berru's setup](https://git.sr.ht/~berru/berrus_defold_linux_setup) - A Linux development setup with automation via `make`.
- [defold.nvim](https://github.com/atomicptr/defold.nvim) — A batteries-included development environment.
- [DoNe](https://github.com/monkoose/DoNe) — A plugin for better Defold experience.

#### Sublime

- [Defold Sublime Text](https://github.com/selimanac/defold-sublime-text) — A package to control the Defold Editor via HTTP, manage the extender server and fetch Lua annotations.
- [Sublime Defold](https://github.com/james2doyle/sublime-defold) — A plugin that enhances the development workflow for the Defold game engine.

#### IntelliJ IDEA

- [Intellij Defold](https://github.com/aridclown/Intellij-Defold) — Coding and debugging support for Defold in IntelliJ-based IDEs.
...
- [Defold Kit (fork)](https://github.com/SalavatR/zed-defold-kit) — Defold API and native extension annotations injected into the Lua language server.
...
- [Def Timeline](https://github.com/AllanDouglas/deftimeline) — Easy way to make animation play in sequence.
- [Defold Actions](https://github.com/d954mas/defold-actions) — Action and tween library with sequences, parallels and wait steps.
...
- [Object Interpolation](https://github.com/indiesoftby/defold-object-interpolation) — Interpolates object position and rotation between fixed update steps.
...
- [SpriteLoop](https://github.com/Balkan-Ram-Games/spriteloop-defold) — Native playback for .spla animation packages with editor integration.
...
- [OMGSERVERS](https://github.com/OMGSERVERS/omgdefold) — SDK for OMGSERVERS, a backend for authoritative game servers.
...
- [Screen Resizer](https://github.com/d954mas/defold-screen-resizer) — Resize the game view from a preset-size development menu.
...
- [SQUID](https://github.com/paweljarosz/squid) — A standalone injectable system for saveable logging of user logs, errors and crashes.
...
- [MicroTAR](https://github.com/indiesoftby/defold-microtar) — TAR archive reader.
...
- [Blender Cube to Lua Table Exporter](https://github.com/yeqwep/ExportBlenderCubes2Lua) — Blender add-on exporting cube data to Lua tables.
...
- [Defold WebP](https://github.com/HalfstarDev/defold-webp) — Native extension for loading WebP images.
...
- [glb2convexshape](https://github.com/LyuRongjian/glb2convexshape) — A library for generate `.convexshape` file from `.glb` file.
...
- [Reforge](https://github.com/ufgo/reforge) — Blender add-on exporting scenes, prefabs and collections into Defold.
...
- [Trim Alpha](https://github.com/d954mas/trim-alpha-script) — Trims transparent PNG borders while preserving sprite alignment.
- [Trim Atlas](https://github.com/maltsevda/trim_atlas) — Trimming of images in the Defold atlas.
...
- [Simplex Noise](https://github.com/indiesoftby/defold-simplex-noise) — A native extension to generate Simplex noise.
...
- [Defold HTML Utils](https://github.com/d954mas/defold-html-utils) — Canvas focus, `localStorage` and mobile-device helpers for HTML5 builds.
...
- [Live Unbundler](https://github.com/HGPoint/defold_live_unbundler) — Extension for Defold Live Update with dynamic chunk loading.
...
- [Virtual Pad Example](https://github.com/d954mas/defold-virtualpad-example) — Example project showing a reusable on-screen virtual pad.
...
- [A* Graph Pathfinding](https://github.com/selimanac/defold-graph-pathfinder) — A high-performance A* pathfinding library designed for real-time games and simulations with hundreds to thousands of moving objects.
- [def-windward-jps](https://github.com/s-kania/def-windward-jps) — A native extension for fast pathfinding using the Jump Point Search algorithm on uniform-cost grids.
...
- [Photon Realtime](https://github.com/defold/extension-photon-realtime) — A native extension for the Photon Realtime framework.
- [Planetary Processing](https://github.com/planetary-Processing/defold-sdk) — A multiplayer toolkit, for creating and hosting online games.
...
- [Physics Tools](https://github.com/indiesoftby/defold-physics-tools) — Helpers for building and debugging 2D physics setups.
...
- [Wave](https://github.com/selimanac/defold-wave) — Native extension simulating waves for floating objects on water.
...
- [Coolmath Games](https://github.com/fabtjar/defold-coolmathgames-sdk) — Coolmath Games SDK native extension.
...
- [Google UMP](https://github.com/tocaRepo/defold-androidextension-ump) — Google's User Messaging Platform.
...
- [Playgama Bridge](https://github.com/playgama/bridge-defold) — One SDK for cross-platform publishing HTML5 games.
- [Poki AUDS](https://github.com/indiesoftby/defold-poki-auds) — Lua module for Poki Arbitrary User Data Store via `http.request`.
...
- [Compute Shaders Examples](https://github.com/abadonna/defold-compute-examples) — Experiments with compute shaders in Defold.
...
- [Mesh Healthbar](https://github.com/FlexYourBrain/sample_mesh-healthbar) — Mesh healthbar sample project.
...
- [Noise Animation Electric](https://github.com/zarkua/Noise-animation-Electric) — A shader of noise animation with an electric effect.
...
- [Pixelart Shader](https://github.com/selimanac/defold-pixelart-shader) — The pixel-art post-process shaders for 3D.
...
- [Usercentrics](https://github.com/HGPoint/def_usercentrics) — Usercentrics CMP for iOS and Android.
- [Xsolla](https://github.com/defold/extension-xsolla) — Xsolla integration for Defold.
...
- [FMOD](https://github.com/defold/extension-fmod) — FMOD sound effects engine integration.
- [Miniaudio](https://github.com/Unreload/Defold-Miniaudio-Extension) — High-performance audio playback and streaming based on miniaudio.
...
- [ADPF](https://github.com/defold/extension-adpf) — Android Dynamic Performance Framework.
- [ANGLE](https://github.com/indiesoftby/defold-graphics-angle) — Windows-only graphics adapter that replaces OpenGL with Google ANGLE.
...
- [3Deforms](https://github.com/Thevisionaire1/3Deforms) — Sample and 3D mesh package with simplest shapes and prototype textures in basic colors.
...
- [Cube Mining](https://github.com/cenullum/cube-mining) — A 3D voxel template with greedy meshing, lighting and collision systems.
...
- [LualocaDE](https://github.com/greedy-chapa/lualocaDE) — An autotranslator with convenient localization json files that supports entries.
...
- [RTL Text](https://github.com/thawri1/defold-rtl-text) — Display right-to-left text correctly in Defold projects.
...
- 🌙 [crop-tileset](https://github.com/Klaleus/crop-tileset) — A script that crops a tileset into individual tiles.
- 🌙 [merge-tileset](https://github.com/Klaleus/merge-tileset) — A script that merges individual tiles into a tileset.
...
- [Flow](https://github.com/Pause-Games/flow) — Flexbox-style UI library with declarative components and stack-based navigation.
...
- [N28S](https://github.com/d954mas/defold-n28s) — Keeps Defold script callbacks on a Lua table instead of global functions.
- 🌙 [betteries](https://github.com/1bardesign/batteries) — Reusable dependencies for games made with Lua.
- 🌙 [immut.lua](https://github.com/BlackMATov/immut.lua) — Immutable and persistent data structures for Lua.
...
- [Christmas 3D Game Demo](https://github.com/d954mas/game-christmas-2025-3D) — 3D demo with ECS, character controller and an in-game editor.
...
- [Perfect+1](https://github.com/appsoluut/perfect-plus1) — A bite-sized, retro-styled, maze puzzle game.
...
- [PowerWash 2D YG](https://github.com/zugzug90/powerwash-2d-yg) — Yandex Games-ready source project for a 2D washing-simulator mechanic.
...
- [SuperWEIRD Game Kit](https://github.com/ludenio/superweirdgamekit) — A six different visual styles and the gameplay logic of a shop/production simulator.
...
- [Tiny City](https://github.com/selimanac/defold-tiny-city) — Tiny Worlds visual demo of a stylized miniature city.
- [Towerz](https://github.com/britzl/towerz) — Defold version of Tipsy Towers.
- [Turn-Based Battle Sample](https://github.com/yeqwep/turnbased_simple_battle) — A classic JRPG-style turn-based battle.
...
- [Wateru](https://github.com/asetsiya/wateru) — Suika game clone for mobile.
...
- [VanillaBeast: Mystery Kink](https://store.steampowered.com/app/2722990) (NSFW)
...
- [Idle Game Dev Simulator](https://play.google.com/store/apps/details?id=com.playcroc.idlegamedev)
...
- [Mummy Maze Pocket](https://play.google.com/store/apps/details?id=io.itch.ksylvestre.mummymazepocket)
...
- [Piece of Cake: Merge & Bake](https://play.google.com/store/apps/details?id=com.happygames.mergecafe)
- [Rare Pets](https://play.google.com/store/apps/details?id=com.drihq.pets)
- [ShiboriLand: Action Platformer](https://play.google.com/store/apps/details?id=com.genesyseast.shiboriland)
- [Solitaire Jazz Travel](https://bigbutton.co/solitaire-jazz-travel)
- [Stick Merge](https://play.google.com/store/apps/details?id=com.tinydobbins.stickmerge)
- [Taxi Town](https://apps.apple.com/app/taxi-town/id1501324428)
- [Zombie Base: Tower Defense TD](https://play.google.com/store/apps/details?id=com.zombie.base.tower.defence.idle.offline)

#### Web

- [Astro Rush](https://sandiagames.itch.io/astro-rush)
...
- [Bos Bedroom](https://poki.com/en/g/bos-bedroom)
- [Bounce Ball](https://poki.com/en/g/bounce-ball)
...
- [The Plantalist](https://purple-planetarium.itch.io/the-plantalist)
